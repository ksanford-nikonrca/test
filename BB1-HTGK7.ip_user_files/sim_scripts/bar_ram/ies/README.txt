...
#
# Generated by export_simulation on Wed Jul 13 18:12:50 -0700 2022
#
################################################################################
...
'-reset_run' switch to the './bar_ram.sh' script.

./bar_ram.sh -reset_run
...
./bar_ram.sh -noclean_files

For more information on the script, please type './bar_ram.sh -help'.
