...
HD_PWD='C:/Users/mcassinerio/Documents/GitHub/HTGK7-NRCA-DMA/HTGK7-NRCA-DMA.runs/PCIe_IP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCIe_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCIe_IP.tcl
