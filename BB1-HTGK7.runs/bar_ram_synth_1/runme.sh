...
HD_PWD='C:/Users/mcassinerio/Documents/GitHub/HTGK7-NRCA-DMA/HTGK7-NRCA-DMA.runs/bar_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bar_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bar_ram.tcl
