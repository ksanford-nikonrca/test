...
HD_PWD='C:/Users/mcassinerio/Documents/GitHub/HTGK7-NRCA-DMA/HTGK7-NRCA-DMA.runs/dma_data_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_data_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_data_ram.tcl
